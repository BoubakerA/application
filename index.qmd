...
```{ojs}
apiRoot = "https://boubakera-titanic.lab.sspcloud.fr"
```

```{ojs}
prediction = `${apiRoot}/predict?sex=${gender}&age=${age}&sib_sp=1&parch=1&fare=16.5&embarked=S&title=${title}&has_cabin=1&ticket_len=7`
```
...
Retrouver l'API sur [https://boubakera-titanic.lab.sspcloud.fr/docs](https://boubakera-titanic.lab.sspcloud.fr/docs) pour jouer avec
d'autres exemples.
